...
public class Config {
	...
	public final static String EMAIL_SMTP_PASSWORD = "jcmrgkikcdqoyjms"; // Application-specific
																			// password
	...
	public final static FilterUnit VALIDATE_NAME = FilterUnit.getNameValidator();
	public final static String SALT = "NaCl"; // Changing this will invalidate
												// all customer passwords in DB
}